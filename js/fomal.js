...
function getWeibo() {
  fetch('https://weibo-9qsvnblo6-pc-study.vercel.app/api').then(data => data.json()).then(data => {  // 这里要写上你的API!!!
...
|      <_/ __ \   /  \ /  \|  \__  \  /  _ \ 
|    |  \  ___/  /    Y    \  |/ __ \(  <_> )
|____|__ \___  > \____|__  /__(____  /\____/ 
        \/   \/          \/        \/         
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by 克喵爱吃卤面 %c 你正在访问克喵の小站",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| 克喵爱吃卤面") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('克喵爱吃卤面的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  var start = new Date("12/17/2024 22:00:00"); // 旅行者1号开始计算的时间
  var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
  var unit = (dis / 149600000).toFixed(6);  // 天文单位
  // 网站诞生时间
  var grt = new Date("12/17/2024 22:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://img.shields.io/badge/克喵の小站-营业中-6adea8?style=social&logo=cakephp' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://img.shields.io/badge/克喵の小站-打烊了-6adea8?style=social&logo=coffeescript' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://jsd.onmicrosoft.cn/gh/Kemiaojun/images@main/img/202412142013072.jpg);
    --darkmode-bg:url(https://jsd.onmicrosoft.cn/gh/Kemiaojun/images@main/img/202412162055538.png);
    --mobileday-bg: url(https://jsd.onmicrosoft.cn/gh/Kemiaojun/images@main/img/202412162055538.png);
    --mobilenight-bg: url(https://jsd.onmicrosoft.cn/gh/Kemiaojun/images@main/img/202412162055540.png);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://jsd.onmicrosoft.cn/gh/Kemiaojun/images@main/img/202412041908746.jpg)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/home_bg.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://jsd.onmicrosoft.cn/gh/Kemiaojun/images@main/img/202412181634958.jpg)" class="pimgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mb4.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 设置自定义背景 </summary>
              <div class='content'>
              <p><center><input type="text" id="pic-link" size="70%" maxlength="1000" placeholder="请输入有效的图片链接，如 https://jsd.onmicrosoft.cn/gh/Kemiaojun/images@main/img/202412181634958.jpg"></center></p><p><center><button type="button" onclick="getPicture()" style="background:var(--theme-color);width:35%;padding: 5px 0px 7px 0px;border-radius:30px;color:white;line-height:2;">🌈切换背景🌈</button></center></p>
              </div>
            </details>
